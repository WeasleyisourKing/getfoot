...
namespace App\PayPal\Auth;

use  App\PayPal\Cache\AuthorizationCache;
use  App\PayPal\Common\PayPalResourceModel;
use  App\PayPal\Core\PayPalHttpConfig;
use  App\PayPal\Core\PayPalHttpConnection;
use  App\PayPal\Core\PayPalLoggingManager;
use  App\PayPal\Exception\PayPalConfigurationException;
use  App\PayPal\Exception\PayPalConnectionException;
use  App\PayPal\Handler\IPayPalHandler;
use  App\PayPal\Rest\ApiContext;
use  App\PayPal\Security\Cipher;
...
class OAuthTokenCredential extends PayPalResourceModel
{
     ...
     */
    public static $AUTH_HANDLER = 'App\PayPal\Handler\OauthHandler';
