...
<head>
	...
	<!-- CSS
  ================================================== -->
	<link rel="stylesheet" href="{{ asset('lib/css/base.css') }}">
		...
		<div class="main-content">
			<div class="row">
				<div class="col-twelve">
					...
					<h1 class="kern-this">404 找不到这个页面呀</h1>
					<h2>您要访问的页面可能已经被绑架了。。。</h2>
					<h2 style="text-decoration:underline;"><a href="/dashboard">返回首页</a></h2>
				</div> <!-- /twelve -->
			</div> <!-- /row -->
		</div> <!-- /main-content -->
