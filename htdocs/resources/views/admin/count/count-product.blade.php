...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <h4 class="pull-left page-title">统计</h4>
    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title">商品销售统计</h3></div>
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="btn-group">
                                <input id="indate1" name="example-input2-group2" class="form-control"
                                       placeholder="Search" type="email">
                            {{--<input id="indate1" name="time1" type="text" placeholder="请选择查询日期"  readonly>--}}
                            </div>
                            <div class="btn-group">
                                <input id="indate2" name="example-input2-group2" class="form-control"
                                       placeholder="Search" type="email">
                            {{--<input id="indate2" name="time2" type="text" placeholder="请选择查询日期"  readonly>--}}
                            </div>
                            <div class="btn-group ">
                ...
                <div class="row m-t-30">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">销售统计列表</h3>
                        </div>
                        <div class="panel-body">
                            <div class="row">
