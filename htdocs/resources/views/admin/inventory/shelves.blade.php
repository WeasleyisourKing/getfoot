		...
		<div class="panel">
			<div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-lg-2">
						<!-- Add 按钮 -->
		                <button class="btn btn-block btn-primary waves-effect waves-light" data-toggle="modal" data-target="#add-item-modal" id="add-item-btn">添加货架<i class="fa fa-plus"></i>
		                </button><!-- End Add 按钮 -->
					</div>
					...
					<div class="col-lg-10">
		                ...
		                <div class="input-group">
                            <input type="text" id="example-input1-group2" name="example-input1-group2" class="form-control input" placeholder="Search">
                            <span class="input-group-btn">
                                <button onclick="search();" type="button" class="btn waves-effect waves-light btn-primary w-md"><i class="fa fa-search"></i></button>
                            </span>
                        </div><!-- End 搜索 -->
					</div>
	...
	<div class="col-sm-4 col-lg-3 panel_box">
		<div class="panel">
			...
			<div class="panel-footer">
				<!---- 编辑按钮 ---->
				<button class="btn-sm btn-info waves-effect waves-light edit-item-btn" data-toggle="modal" data-target="#edit-item-modal" onclick="edit(this);"
						data-id="{{$item->id}}" data-name="{{$item->name}}"  data-number="{{$item->number}}"data-status="{{$item->status}}"><i class="fa fa-edit"></i></button><!---- End 编辑按钮 ---->
				<!---- 删除按钮 ---->
				<button data-id="{{$item->id}}" class="btn-sm btn-danger waves-effect waves-light delete-item-btn" onclick="del(this);" ><i class="fa fa-trash"></i></button><!---- End 删除按钮 ---->
			</div>
		</div>
	</div><!---- End 货架 ---->
...
<!---- 弹窗 ---->
	...
	<!---- 编辑 ---->
	<div id="edit-item-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="editModal" aria-hidden="true">
	    <div class="modal-dialog" style="width: 60%"> 
	        <div class="modal-content"> 
	            <div class="modal-header"> 
	                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> 
	            ...
	            <div class="modal-footer"> 
	                <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button> 
	                <button type="button" class="btn btn-info waves-effect waves-light" id="edit-save" onclick="efunb(this);"><i class="fa fa-save"></i> Save</button>
	            </div> 
	        </div> 
	    </div>
	</div><!---- End 编辑 ---->
