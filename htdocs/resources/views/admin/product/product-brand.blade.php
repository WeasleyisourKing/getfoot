...
@section('content')
    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title">品牌管理</h3></div>
                            ...
                            <div class="row m-t-10">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <table class="table table-bordered">
                                        <thead>
                                        <tr>
                                            <th class="col-md-3 col-lg-3 exce"> 品牌名称</th>
...
//        $('#select20').attr('href', val3);
    ...
    <script>
        ...
        $('#sa-save').click(function () {
            ...
            $.post('/brand/insert', datas, function (res) {
                if (res.status) {
                    alertify.success('创建品牌成功');
                    setTimeout(function () {
                        location.reload();
                    }, 1500);
                } else {
    ...
    <script>
       ...
       var efunb = function (event) {
            ...
            $.post('/brand/editor', datas, function (res) {
                if (res.status) {
                    alertify.success('修改品牌成功');
                    setTimeout(function () {
                        location.reload();
                    }, 1500);
                } else {
        ...
        var del = function (event) {
            ...
            alertify.confirm("确认框", function (e) {
                if (e) {
                    ...
                    $.get('/brand/del', {'id': $(event).attr('data-id')}, function (res) {
