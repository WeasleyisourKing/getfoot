...
@section('content')
        ...
        <div class="modal-dialog" style="width: 1000px;height: 300px;">
            ...
            <div class="modal-content">
                ...
                <div class="form-group">
                    <ul id="myTab" class="nav nav-tabs navtab-bg nav-justified">
                        ...
                        <li class="dropdown">
                            <a href="#" id="myTabDrop1" class="dropdown-toggle"
                               data-toggle="dropdown">属性 <b class="caret"></b>
                            </a>
                    ...
                    <div id="myTabContent" style="box-shadow: none !important;border-right: 1px;border-left: 1px"
                         class="tab-content">
                        ...
                        <div class="tab-pane fade " id="prices">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="one_price" id="one_price"
                                           class="form-control"
                                           value="0.00" required="required"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="two_price" id="two_price"
                                           class="form-control"
                                           value="0.00" required="required"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="three_price" id="three_price"
                                           class="form-control"
                                           value="0.00" required="required"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="four_price" id="four_price"
                                           class="form-control"
                                           value="0.00" required="required"/>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="img">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="file" name="img" id="uploadfile" multiple
                                           class="file-loading"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="describe" style="overflow: hidden;">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="summary">商品关键词（最多100字）<span
                                            class="red">＊</span></label>
                                <div class="controls">
                                            <textarea maxlength="100" name="summary" id="summary"
                ...
                <div class="modal-footer" style="border: 0">
                    ...
                    <button type="button" id="sa-success" onclick="funb();"
            ...
            <div class="modal-content">
                ...
                <div class="form-group">
                    <ul id="myTab" class="nav nav-tabs navtab-bg nav-justified">
                        ...
                        <li class="dropdown">
                            <a href="#" id="emyTabDrop1" class="dropdown-toggle"
                               data-toggle="dropdown">属性 <b class="caret"></b>
                            </a>
                    ...
                    <div id="myTabContent" style="box-shadow: none !important;border-right: 1px;border-left: 1px"
                        ...
                        <div class="tab-pane fade " id="eprices">
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="eone_price" id="eone_price"
                                           class="form-control"
                                           value="" required="required"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="etwo_price" id="etwo_price"
                                           class="form-control"
                                           value="" required="required"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="ethree_price">商业用户（$）<span
                                            class="red">＊</span></label>
                                <div class="controls">
                                    <input type="text" name="ethree_price" id="ethree_price"
                                           class="form-control"
                                           value="" required="required"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="efour_price" id="efour_price"
                                           class="form-control"
                                           value="" required="required"/>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="edescribe" style="overflow: hidden;">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="esummary">商品关键词（最多100字）<span
                                            class="red">＊</span></label>
                                <div class="controls">
                                            <textarea maxlength="100" name="esummary" id="esummary"
                                                      style=" resize: none;height: 100px;" class="form-control"
                                                      value=""></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label" for="eterm">商品保质期（天）<span
                                            class="red">＊</span></label>
                                <div class="controls">
                                    <input type="text" name="eterm" id="eterm"
                                           class="form-control"
                                           value="" required="required"/>
                                </div>
                            </div>
                            ...
                            {{--style="color:red;">＊</span></label>--}}
                            {{--<div class="controls">--}}
                            {{--<input type="text" name="enet_weight" id="enet_weight"--}}
                            {{--class="form-control"--}}
                            {{--value="" required="required"/>--}}
                            {{--</div>--}}
                            {{--</div>--}}
                            ...
                            {{--style="color:red;">＊</span></label>--}}
                            {{--<div class="controls">--}}
                            {{--<input type="text" name="eweight" id="eweight"--}}
                            {{--class="form-control"--}}
                            {{--value="" required="required"/>--}}
                            {{--</div>--}}
                            {{--</div>--}}
                            ...
                            {{--<label class="control-label" for="title">商品保质到期时间</label>--}}
                            {{--<div class="controls">--}}
                            {{--<input class="form-control" id="eterm" name="indate" value="" type="text"--}}
                            {{--placeholder="请选择查询日期" readonly>--}}
                            {{--</div>--}}
                            {{--</div>--}}
                ...
                <div class="modal-footer" style="border: 0">
                    <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
                    <button type="button" id="sa-save" data-id="" onclick="efunb(this);"
                            class="btn btn-primary waves-effect waves-light"><i class="fa fa-save"></i> Save
                    </button>
                </div>
            </div>
    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title">商品管理</h3></div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="input-group ">
                            <div class="btn-group">
                                <button id="fcategory" type="button" class="btn btn-primary dropdown-toggle"
                                        data-toggle="dropdown"
                                        aria-expanded="true"
                                        style="max-width: 96px; overflow-x: hidden;">{{$categoryVal}} <span
                                            ...
                                            <ul id="ccategory" class="dropdown-menu" role="menu">
                                                ...
                                                @foreach ($category as $items)
                                                    @if (!empty($items['pid']))
                                                        ...
                                                        @foreach ($items['pid'] as $v)
                                                            <li><a href="javascript:void(0);" data-data="{{$v['id']}}"
                                                                   data-name="{{$v['zn_name']}}
                            ...
                            <div class="btn-group">
                                <button id="fbrand" type="button" class="btn btn-primary dropdown-toggle"
                                        data-toggle="dropdown"
                                        aria-expanded="true" style="max-width: 96px; overflow-x: hidden;">{{$brandVal}}
                            ...
                            <div class="btn-group">
                                <button id="status" type="button" class="btn btn-primary dropdown-toggle"
                                        data-toggle="dropdown"
                                        aria-expanded="true" style="max-width: 96px; overflow-x: hidden;">{{$status}}
                                    <span class="caret"></span></button>
                    ...
                    <div class="col-sm-3 ">
                        ...
                        <div class="input-group">
                            <input id="searchString" class="form-control"
                                   placeholder="请输入商品中文名称" type="text">
                                            ...
                                            <tr>
                                                ...
                                                <td class="exce">
                                                    ...
                                                    <a title="查看信息" class="btn btn-success waves-effect waves-light"
                                                       ...
                                                       data-category="{{ $item->category->zn_name }}（{{ $item->category->en_name }}）"
                                                       data-brand="{{ $item->brand->zn_name }}（{{ $item->brand->en_name }}）"
...
//                    return;
//                }
                window.attrData.push({'name': $('#attr' + i).val(), 'attr': attrText});
            }
...
//                'net_weightUnit': $('#net_weightUnit').val(),
    ...
    <script>
        ...
        $("#ups").click(function () {
            ...
            $.get('/product/up', {'arr': data}, function (res) {
        ...
        $("#downs").click(function () {
            ...
            $.get('/product/down', {'arr': data}, function (res) {
        ...
        var del = function (event) {
            ...
            alertify.confirm("确认框", function (e) {
                if (e) {
                    ...
                    $.get('/product/del', {'id': $(event).attr('data-id')}, function (res) {
...
//                    }
                ...
                window.eattrData.push({'name': $('#eattr' + i).val(), 'attr': eattrText});
            }
...
//           console.log(window.eimgAddress);return;
    ...
    <script>
        ...
        function doSearch() {
            ...
            $.get('/api/product/search', {'search': search}, function (res) {
