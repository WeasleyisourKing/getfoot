...
console.log(res.data[i]);
                        ...
                        <td class="exce">
                         ...
                         <td class="exce"><img height="100px; align=" middle"
                            ...
                            data-oneprice="${res.data[i].distributor.level_one_price}"
                            data-twoprice="${res.data[i].distributor.level_two_price}"
                            data-threeprice="${res.data[i].distributor.level_three_price}"
                            data-fourprice="${res.data[i].distributor.level_four_price}"
