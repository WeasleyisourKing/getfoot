...
@section('content')
    ...
    <div class="row">
        <div class="panel panel-default">
            <div class="panel-heading"><h3 class="panel-title">商品出库</h3></div>
            ...
            document.onkeyup = function (e) {
                ...
                if (code == 13) {
                    ...
                    $("input[name='dataStock']").each(function () {
                        ...
                        if (($(this).val() != '') && (Number($(this).attr('data-data')) >= Number($(this).val()))) {
                    ...
                    if (window.data.length > 0) {
                        ...
                        $.post('/stock/product/sub', {'data':window.data, '_token': '{{csrf_token()}}'}, function (res) {
                        ...
                        alertify.alert('没有商品的库存改变或相减小于0');
                    }
                }
            }
        });
                ...
                if (res.status) {
                    if (res.data.length == 0) {
                        ...
                        var datas = '<thead>' +
                            ...
                            '<th class="col-md-2 col-lg-2 exce">库存数量</th>' +
                            ' </tr>' +
