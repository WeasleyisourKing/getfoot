						...
						<div class="myOder">
								<div class="myOderDetail clearfloat">
									...
									<div class="am-u-sm-2 myOderDetailText">
										<p>${products[i].count}
											<br>
											<span>${Sprice1(products[i].distributor.level_four_price,products[i].distributor.level_two_price,products[i].distributor.level_one_price,products[i].distributor.level_three_price)}</span>
											<br>
